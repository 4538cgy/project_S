    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (obj.type){
            RecyclerDefaultModel.TEXT_TYPE_2 -> {
                ...
                holder.binding.itemMultiViewTextType2TextviewTitle.text = list[position].text
            }
            RecyclerDefaultModel.TEXT_TYPE -> {
                (holder as TextTypeViewHolder).onBind(list[position])
                holder.binding.itemMultiViewTextTypeTextviewTitle.text = list[position].text
            }
            RecyclerDefaultModel.IMAGE_TYPE -> {
                (holder as ImageTypeViewHolder).onBind(list[position])
                holder.binding.itemMultiViewImageTypeTextviewTitle.text = list[position].text
            ...
            RecyclerDefaultModel.IMAGE_TYPE_2 -> {
                ...
                holder.binding.itemMultiViewImageType2TextviewTitle.text = list[position].text
